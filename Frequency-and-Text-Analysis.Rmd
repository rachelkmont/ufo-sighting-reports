...
first, lets see if there is any correlation between our variables 

in order to see correlations, need to subset the data into just our numeric variables
...
in order to make plot for ppt, limit each year's plot for top 5 months and show across in one line
...
grid.arrange(w15,w16,w17,w18,w19, nrow = 1, top="Sightings per Month")

```

attempt again with using facet wrap 

```{r}
# ggplot(subset(UFO_and_Weather, year %in% c(2015, 2016,2017,2018)),
#        aes(x = Month)) +
#   geom_bar(aes(color=Month), alpha = 0.5) +
#   geom_point(alpha = 0.8,
#              size = 0.4) +
#   theme_light() +
#   labs(title = "ufo across years",
#        x = "Count",
#        y = "Year") +
...
Overall, this sentiment analysis isn't as relevant and is subjective, and therefore will not be included in the final report of findsings.
