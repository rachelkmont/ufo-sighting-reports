...
ggplot(UFO_and_Weather, aes(x = reorder(Month, Month, FUN = length))) +
  geom_bar(alpha = 0.7, fill = "forestgreen") +
...
w19 <- ggplot(weather_2019, aes(x=reorder(Month, Month, FUN=length)))+
  geom_bar()+
  labs(title="2019", x="month", y="count")+
  coord_flip()
...
w18 <- ggplot(weather_2018, aes(x=reorder(Month, Month, FUN=length)))+
  geom_bar()+
  labs(title="2018", x="month", y="count")+
  coord_flip()
...
w17 <- ggplot(weather_2017, aes(x=reorder(Month, Month, FUN=length)))+
  geom_bar()+
  labs(title="2017", x="month", y="count")+
  coord_flip()
...
w16 <- ggplot(weather_2016, aes(x=reorder(Month, Month, FUN=length)))+
  geom_bar()+
  labs(title="2016", x="month", y="count")+
  coord_flip()
...
w15 <- ggplot(weather_2015, aes(x=reorder(Month, Month, FUN=length)))+
  geom_bar()+
  labs(title="2015", x="month", y="count")+
  coord_flip()

#now lets plot all the years at the same time using the patchwork library
w15 + w16 + w17 + w18 + w19
...
Let's investigate the popularity of months if we remove the July 4th outlier.
...
ggplot(UFO_and_Weather, aes(x=hour)) + 
  ...
  labs(x = "Hour of the day", y = "Number of sightings", 
       title="UFO Sightings throughout the day")
```
...
The states with the most reports are California, Washington, and Arizona.
